...
<head>
    ...
    <title>PHP OOP-Static property and Method</title>
</head>
<body>
...
<div class="navbar navbar-dark bg-dark">
    ...
    <div class="container">
        ...
        <div class="navbar-brand pb-4 pt-4">PHP OOP-Static property and Method</div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            ...
            /**
             * Access the static property of the class
             */

             echo Person::$drinkingAge;

             Person::setDrinkinAge(18);
